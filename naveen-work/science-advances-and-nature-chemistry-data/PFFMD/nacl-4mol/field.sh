...
$dipolexe/exe /home/naveenk/energytransfer/restarts/$ion/traj$i.arc traj.psf 100 32 15.00 328 120 /home/naveenk/my_programs/Dipole-Polarisability5/field_atomicunit  $outputfileloc/one$i  $outputfileloc/two$i $outputfileloc/three$i  $outputfileloc/four$i
done
