...
taskset --cpu-list 1 $tinkerexe/dynamic.x water 300 1 0.3 2 300
n+=1
tail -330 water.arc |tee  $restartfileloc/frame$n.xyz
tail -1321 water.dyn |tee  $restartfileloc/frame$n.dyn
