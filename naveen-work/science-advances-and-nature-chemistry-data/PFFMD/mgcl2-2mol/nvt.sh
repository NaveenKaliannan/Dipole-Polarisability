...
taskset --cpu-list 2 $tinkerexe/dynamic.x  water 300 1 0.3 2 300
n+=1
tail -380 water.arc |tee  $restartfileloc/frame$n.xyz
tail -1521 water.dyn |tee  $restartfileloc/frame$n.dyn
