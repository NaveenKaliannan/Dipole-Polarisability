...
taskset --cpu-list 4 $tinkerexe/dynamic.x  water 300 1 0.3 2 300
n+=1
tail -391 water.arc |tee  $restartfileloc/frame$n.xyz
tail -1565 water.dyn |tee  $restartfileloc/frame$n.dyn
