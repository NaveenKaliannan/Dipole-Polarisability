...
taskset --cpu-list 0 $tinkerexe/dynamic.x water 300 1 0.3 2 300
n+=1
tail -336 water.arc |tee  $restartfileloc/frame$n.xyz
tail -1345 water.dyn |tee  $restartfileloc/frame$n.dyn
