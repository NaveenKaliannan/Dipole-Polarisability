...
#sed -i 's/HW1/H/g' $a
#sed -i 's/HW2/H/g' $a
$dipolexe/exe $ensemble.gro traj.psf 100 32 15.72 405 135 /home/naveenk/my_programs/Dipole-Polarisability4/field_atomicunit  $outputfileloc/one$i  $outputfileloc/two$i $outputfileloc/three$i  $outputfileloc/four$i
rm -rf *trr* *gro* *cpt*
rm rf *log* *xtc* *xvg*
