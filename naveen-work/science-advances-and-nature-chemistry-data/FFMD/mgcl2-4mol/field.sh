...
$dipolexe/exe $ensemble.gro traj.psf 4998  0.4 15 327 125  /home/naveenk/energytransfer/simdata/$ion/all_velocities$i.dat /home/naveenk/energytransfer/simdata/$ion/one$i /home/naveenk/energytransfer/simdata/$ion/two$i /home/naveenk/energytransfer/simdata/$ion/three$i /home/naveenk/energytransfer/simdata/$ion/four$i /home/naveenk/energytransfer/simdata/$ion/five$i

#$dipolexe/exe $ensemble.gro traj.psf 100 32 15 327 125  /home/naveenk/my_programs/Dipole-Polarisability4/field_atomicunit  $outputfileloc/one$i  $outputfileloc/two$i $outputfileloc/three$i  $outputfileloc/four$i
#$dipolexe/exe $ensemble.gro traj.psf 8000 0.4 15 327 125  /home/naveenk/my_programs/Dipole-Polarisability4/field_atomicunit  $outputfileloc/one$i  $outputfileloc/two$i $outputfileloc/three$i  $outputfileloc/four$i
rm -rf *trr* *gro* *cpt*
rm rf *log* *xtc* *xvg*
